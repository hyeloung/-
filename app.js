...
function renderPage(num) {
    ...
    pdfDoc.getPage(pdfPageNum).then(page => {
        ...
        page.render(renderContext).promise.then(() => {
            ...
            const staticImages = ['page1-img', 'page2-img', 'page3-img', 'page4-img', 'page5-img', 'page6-img', 'page7-img', 'page8-img', 'page9-img', 'page10-img', 'page11-img', 'page12-img', 'page13-img', 'page14-img', 'page15-img', 'page16-img'];
