...
function renderPage(num) {
    ...
    pdfDoc.getPage(pdfPageNum).then(page => {
        ...
        page.render(renderContext).promise.then(() => {
            ...
            const staticImages = ['page1-img', 'page2-img', 'page4-img', 'page5-img', 'page6-img', 'page8-img', 'page9-img', 'page10-img', 'page12-img', 'page13-img'];
            staticImages.forEach(id => {
                const img = document.getElementById(id);
                if (img) img.classList.add('hidden');
            });

            if (num === 1 || num === 2 || num === 4 || num === 5 || num === 6 || num === 8 || num === 9 || num === 10 || num === 12 || num === 13) {
